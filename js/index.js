...
let bookmarkStor = JSON.parse(window.localStorage.getItem("bookmarks"))
const bookmarks = bookmarkStor || [];
...
const renderBookmarks = function (arr, htmlElement) {
  arr.forEach((bookmark) => {
    ...
    newItem.setAttribute("class"," mt-3 d-flex justify-content-between border border-3 p-2 rounded-2 border-primary bg-light")
...
renderBookmarks(bookmarkStor, elBookmarksList);
